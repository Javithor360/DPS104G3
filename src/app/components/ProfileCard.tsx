...
const ProfileCard = ({
  ...
  tecnologias,
  avatar,
  disponible = true, // valor por defecto si no se pasa la prop
}: ProfileProps) => {
  return (
    <div
      style={{
    ...
    >
      ...
      <img
        src={
          avatar ??
          `https://ui-avatars.com/api/?name=${nombre}&background=003f7f&color=fff`
        }
        alt={nombre}
        style={{
          width: "72px",
      ...
      <p style={{ color: "#5a6a7e", margin: "0 0 12px", fontSize: ".9rem" }}>
        {rol}
      </p>
