...
export default function RegisterForm() {
  ...
  const handleChange = (campo: Campo, valor: string): void => {
    ...
    setErrores((prev) => ({
      ...prev,
      [campo]: validarCampo(campo, valor, nuevoFormData),
    }));
  };
  ...
  if (exito) {
    return (
      ...
      >
        ...
        <h3 style={{ color: "#007a3d", margin: "0 0 8px" }}>
          ¡Registro exitoso!
        </h3>
        <p style={{ color: "#5a6a7e" }}>
          Bienvenido/a, <strong>{formData.nombre}</strong>
        </p>
        <button
          onClick={() => {
  ...
  return (
    <div
      style={{
        ...
        padding: "32px",
        maxWidth: "460px",
        boxShadow: "0 2px 12px rgba(0,63,127,.08)",
      }}
    >
      ...
      <div style={{ marginBottom: "18px" }}>
        ...
        {errores.nombre && (
          <p
            style={{ color: "#c0392b", fontSize: ".78rem", margin: "4px 0 0" }}
          >
            ⚠ {errores.nombre}
          </p>
        )}
